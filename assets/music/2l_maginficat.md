...
Μπορείτε να προμηθευτείτε το ψηφιακό αρχείο σε διάφορες μορφές (η έκδοση 5.1 συνιστάται ανεπιφύλακτα για όσους έχουν ηχοσύστημα surround) απευθείας από το ψηφιακό κατάστημα της δισκογραφικής [εδώ](https://shop.2l.no/collections/frontpage/products/magnificat-nidarosdomen?variant=39666385780919)

ή να την ακούσετε εδώ: 

- [spotify](https://open.spotify.com/album/15fzAFOBebAi8U1q3rhsnC) (απαιτείται δωρεάν εγγραφή στην υπηρεσία)
- [tidal](https://tidal.com/) (απαιτείται συνδρομή επί πληρωμή)
